...
export function Scrubber({
  ...
  return (
    <View style={s.wrap}>
      ...
      {/* Frames, not a clock, and nothing else. The only reason to read this
          line is to confirm a single step moved by exactly one. */}
...
const s = StyleSheet.create({
  ...
  readout: { alignItems: 'center', marginTop: space.xs },
});
